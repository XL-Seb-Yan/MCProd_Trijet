...
cp -r /afs/cern.ch/work/x/xuyan/TrijetProj/MCProd/FullSim/2017/Configuration ./
...
cmsDriver.py  --python_filename NanoAOD_cfg.py --eventcontent NANOEDMAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --fileout file:nanoAOD.root --conditions 106X_mc2017_realistic_v8 --step NANO --filein file:miniAOD.root --era Run2_2017,run2_nanoAOD_106Xv1 --no_exec --mc -n ${numevt}
